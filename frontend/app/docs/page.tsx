  ...
  "timestamp": 1716000000
          ...
          <div className="space-y-3 mb-8">
            {([
              ...
              {
                phase: "v0.2 — Marketplace Core (Shipped)",
                status: "shipped",
                color: "#22c55e",
                items: [
              ...
              {
                phase: "v0.2.1 — In Progress",
                status: "active",
                color: "#f59e0b",
                items: [
                  { text: "Proposals, profile editor, ratings & cancel/refund UI surfaces (contract layer is live)", badge: "Working" },
              ...
              {
                phase: "Security Hardening — Shipped",
                status: "shipped",
                color: "#22c55e",
                items: [
